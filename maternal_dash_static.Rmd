---
title: "Dashboard Tutorial static"
output: 
...
### Here is an example of making plots
...
If this was rendered by shiny, I could use interactivity to change the input/output of plots
...
# syntax for plotly
# renderPlotly({
# render only if shiny
  
maternal %>% filter(site == "A") %>% # filters only the site the user chose
